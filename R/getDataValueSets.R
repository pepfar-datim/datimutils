...
getDataValueSets <- function(variable_keys = NULL, #keys,
  ...
  if((
    ...
    stop("Either at least one period or a start date and end date must be specified.")
  }
  ...
  #4 Organisation units must be within the hierarchy of the organisation units of the authenticated user.
