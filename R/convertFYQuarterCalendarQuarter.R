#' @export
#' @title convertFYQuarterCalendarQuarter
...
#' @return "yyyyQQ"
#' @example convertFYQuarterCalendarQuarter(1995,1)
convertFYQuarterCalendarQuarter <- function(fiscal_yyyy_int, fiscal_q_int) {
