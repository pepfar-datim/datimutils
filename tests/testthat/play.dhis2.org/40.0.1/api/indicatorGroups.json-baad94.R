structure(list(url = "https://play.dhis2.org/40.0.1/api/indicatorGroups.json?paging=false&filter=id:in:[oehv9EO3vP7]&fields=id,name", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Tue, 05 Sep 2023 13:10:28 GMT", `content-type` = "application/json;charset=UTF-8", 
        ...
        `cache-control` = "no-cache, private", etag = "W/\"0d9715af44dbbf17fd360023e2a992359\"", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Tue, 05 Sep 2023 13:10:28 GMT", 
            `content-type` = "text/html", `content-length` = "162", 
            connection = "keep-alive", location = "https://play.dhis2.org/40.0.1/api/indicatorGroups.json?paging=false&filter=id:in:[oehv9EO3vP7]&fields=id,name"), class = c("insensitive", 
        "list"))), list(status = 200L, version = "HTTP/2", headers = structure(list(
        server = "nginx", date = "Tue, 05 Sep 2023 13:10:28 GMT", 
    ...
    date = structure(1693919428, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.043276, namelookup = 8.9e-05, 
    connect = 0, pretransfer = 0.000249, starttransfer = 0.108349, 
    total = 0.108526)), class = "response")
