structure(list(url = "https://play.dhis2.org/40.0.1/api/indicators.json?paging=false&filter=id:in:[ReUHfIn0pTQ]&fields=id,name", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Tue, 05 Sep 2023 13:14:51 GMT", `content-type` = "application/json;charset=UTF-8", 
        ...
        `cache-control` = "no-cache, private", etag = "W/\"0fd8278bbb3370e2fb716c69574c30390\"", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Tue, 05 Sep 2023 13:14:51 GMT", 
            `content-type` = "text/html", `content-length` = "162", 
            connection = "keep-alive", location = "https://play.dhis2.org/40.0.1/api/indicators.json?paging=false&filter=id:in:[ReUHfIn0pTQ]&fields=id,name"), class = c("insensitive", 
        "list"))), list(status = 200L, version = "HTTP/2", headers = structure(list(
        server = "nginx", date = "Tue, 05 Sep 2023 13:14:51 GMT", 
    ...
    date = structure(1693919691, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.044754, namelookup = 8e-05, 
    connect = 0, pretransfer = 0.000249, starttransfer = 0.10738, 
    total = 0.107593)), class = "response")
