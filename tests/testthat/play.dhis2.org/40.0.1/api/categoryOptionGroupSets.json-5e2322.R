structure(list(url = "https://play.dhis2.org/40.0.1/api/categoryOptionGroupSets.json?paging=false&filter=id:in:[C31vHZqu0qU]&fields=id,name", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Tue, 05 Sep 2023 13:08:34 GMT", `content-type` = "application/json;charset=UTF-8", 
        ...
        `cache-control` = "no-cache, private", etag = "W/\"0413fc1226b23eae819934e9d3e7202dd\"", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Tue, 05 Sep 2023 13:08:34 GMT", 
            `content-type` = "text/html", `content-length` = "162", 
            connection = "keep-alive", location = "https://play.dhis2.org/40.0.1/api/categoryOptionGroupSets.json?paging=false&filter=id:in:[C31vHZqu0qU]&fields=id,name"), class = c("insensitive", 
        "list"))), list(status = 200L, version = "HTTP/2", headers = structure(list(
        server = "nginx", date = "Tue, 05 Sep 2023 13:08:34 GMT", 
    ...
    date = structure(1693919314, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.045061, namelookup = 8.5e-05, 
    connect = 0, pretransfer = 0.000252, starttransfer = 0.112318, 
    total = 0.112451)), class = "response")
