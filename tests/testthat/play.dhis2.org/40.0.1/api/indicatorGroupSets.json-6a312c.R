structure(list(url = "https://play.dhis2.org/40.0.1/api/indicatorGroupSets.json?paging=false&filter=id:in:[tOwnTs7TL3Y]&fields=id,name", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Tue, 05 Sep 2023 13:10:20 GMT", `content-type` = "application/json;charset=UTF-8", 
        ...
        `cache-control` = "no-cache, private", etag = "W/\"0f2ebab60c57a37a63e91e25c00cf2536\"", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Tue, 05 Sep 2023 13:10:20 GMT", 
            `content-type` = "text/html", `content-length` = "162", 
            connection = "keep-alive", location = "https://play.dhis2.org/40.0.1/api/indicatorGroupSets.json?paging=false&filter=id:in:[tOwnTs7TL3Y]&fields=id,name"), class = c("insensitive", 
        "list"))), list(status = 200L, version = "HTTP/2", headers = structure(list(
        server = "nginx", date = "Tue, 05 Sep 2023 13:10:20 GMT", 
    ...
    date = structure(1693919420, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.045472, namelookup = 9.7e-05, 
    connect = 0, pretransfer = 0.000248, starttransfer = 0.116014, 
    total = 0.116243)), class = "response")
