structure(list(url = "https://play.dhis2.org/40.0.1/api/dataElements.json?paging=false&filter=id:eq:FTRrcoaog83&fields=name,id", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Tue, 05 Sep 2023 10:29:24 GMT", `content-type` = "application/json;charset=UTF-8", 
        ...
        `cache-control` = "no-cache, private", etag = "W/\"010db96a7ee78df9e15395857cc08223b\"", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Tue, 05 Sep 2023 10:29:24 GMT", 
            `content-type` = "text/html", `content-length` = "162", 
            connection = "keep-alive", location = "https://play.dhis2.org/40.0.1/api/dataElements.json?paging=false&filter=id:eq:FTRrcoaog83&fields=name,id"), class = c("insensitive", 
        "list"))), list(status = 200L, version = "HTTP/2", headers = structure(list(
        server = "nginx", date = "Tue, 05 Sep 2023 10:29:24 GMT", 
    ...
    date = structure(1693909764, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.146493, namelookup = 0.05973, 
    connect = 0.145644, pretransfer = 0.183287, starttransfer = 0.314818, 
    total = 0.314907)), class = "response")
