structure(list(url = "https://play.dhis2.org/40.0.1/api/dataElements.json?paging=false&filter=id:in:[FTRrcoaog83]&fields=id,name", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Tue, 05 Sep 2023 13:09:17 GMT", `content-type` = "application/json;charset=UTF-8", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Tue, 05 Sep 2023 13:09:17 GMT", 
            `content-type` = "text/html", `content-length` = "162", 
            connection = "keep-alive", location = "https://play.dhis2.org/40.0.1/api/dataElements.json?paging=false&filter=id:in:[FTRrcoaog83]&fields=id,name"), class = c("insensitive", 
        "list"))), list(status = 200L, version = "HTTP/2", headers = structure(list(
        server = "nginx", date = "Tue, 05 Sep 2023 13:09:17 GMT", 
    ...
    date = structure(1693919357, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.095205, namelookup = 0.002683, 
    connect = 0.092062, pretransfer = 0.1393, starttransfer = 0.24901, 
    total = 0.249112)), class = "response")
