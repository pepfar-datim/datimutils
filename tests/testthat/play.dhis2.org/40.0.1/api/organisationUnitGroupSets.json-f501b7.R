structure(list(url = "https://play.dhis2.org/40.0.1/api/organisationUnitGroupSets.json?paging=false&filter=id:in:[uIuxlbV1vRT]&fields=id,name", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Tue, 05 Sep 2023 13:16:05 GMT", `content-type` = "application/json;charset=UTF-8", 
        ...
        `cache-control` = "no-cache, private", etag = "W/\"0c7167eec7bb6d021d433d6dae4e36a49\"", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Tue, 05 Sep 2023 13:16:04 GMT", 
            `content-type` = "text/html", `content-length` = "162", 
            connection = "keep-alive", location = "https://play.dhis2.org/40.0.1/api/organisationUnitGroupSets.json?paging=false&filter=id:in:[uIuxlbV1vRT]&fields=id,name"), class = c("insensitive", 
        "list"))), list(status = 200L, version = "HTTP/2", headers = structure(list(
        server = "nginx", date = "Tue, 05 Sep 2023 13:16:05 GMT", 
    ...
    date = structure(1693919765, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.0448, namelookup = 8.9e-05, 
    connect = 0, pretransfer = 0.00029, starttransfer = 0.110347, 
    total = 0.11048)), class = "response")
