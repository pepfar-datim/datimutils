structure(list(url = "https://play.dhis2.org/40.0.1/api/organisationUnits.json?paging=false&filter=name:like:Sierra%20Leone&fields=name,id", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        ...
        `cache-control` = "no-cache, private", etag = "W/\"0f145346ef434e2fa626ce3b81df5b849\"", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Tue, 05 Sep 2023 10:29:42 GMT", 
            `content-type` = "text/html", `content-length` = "162", 
            connection = "keep-alive", location = "https://play.dhis2.org/40.0.1/api/organisationUnits.json?paging=false&filter=name:like:Sierra%20Leone&fields=name,id"), class = c("insensitive", 
    ...
    ), tzone = "GMT"), times = c(redirect = 0.044845, namelookup = 8.5e-05, 
    connect = 0, pretransfer = 0.000251, starttransfer = 0.105546, 
    total = 0.105675)), class = "response")
