structure(list(url = "https://play.dhis2.org/40.0.1/api/categoryCombos.json?paging=false&filter=id:in:[m2jTvAj5kkm]&fields=id,name", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Tue, 05 Sep 2023 13:08:17 GMT", `content-type` = "application/json;charset=UTF-8", 
        ...
        `cache-control` = "no-cache, private", etag = "W/\"07ffe8ea4a311bd2f7d4d42aeeb4689f6\"", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Tue, 05 Sep 2023 13:08:17 GMT", 
            `content-type` = "text/html", `content-length` = "162", 
            connection = "keep-alive", location = "https://play.dhis2.org/40.0.1/api/categoryCombos.json?paging=false&filter=id:in:[m2jTvAj5kkm]&fields=id,name"), class = c("insensitive", 
        "list"))), list(status = 200L, version = "HTTP/2", headers = structure(list(
        server = "nginx", date = "Tue, 05 Sep 2023 13:08:17 GMT", 
    ...
    date = structure(1693919297, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.045829, namelookup = 0.000115, 
    connect = 0, pretransfer = 0.000327, starttransfer = 0.115241, 
    total = 0.115369)), class = "response")
