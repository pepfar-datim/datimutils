structure(list(url = "https://play.dhis2.org/40.0.1/api/optionGroupSets.json?paging=false&filter=id:in:[Wonln7Yg5Am]&fields=id,name", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Tue, 05 Sep 2023 13:10:45 GMT", `content-type` = "application/json;charset=UTF-8", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Tue, 05 Sep 2023 13:10:45 GMT", 
            `content-type` = "text/html", `content-length` = "162", 
            connection = "keep-alive", location = "https://play.dhis2.org/40.0.1/api/optionGroupSets.json?paging=false&filter=id:in:[Wonln7Yg5Am]&fields=id,name"), class = c("insensitive", 
        "list"))), list(status = 200L, version = "HTTP/2", headers = structure(list(
        server = "nginx", date = "Tue, 05 Sep 2023 13:10:45 GMT", 
    ...
    date = structure(1693919445, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.044813, namelookup = 8.5e-05, 
    connect = 0, pretransfer = 0.000259, starttransfer = 0.107244, 
    total = 0.107381)), class = "response")
