structure(list(url = "https://play.dhis2.org/40.0.1/api/optionSets.json?paging=false&filter=id:in:[VQ2lai3OfVG]&fields=id,name", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Tue, 05 Sep 2023 13:15:46 GMT", `content-type` = "application/json;charset=UTF-8", 
        ...
        `cache-control` = "no-cache, private", etag = "W/\"0e18bf8286de8375b423c49f3f1fef0a0\"", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Tue, 05 Sep 2023 13:15:46 GMT", 
            `content-type` = "text/html", `content-length` = "162", 
            connection = "keep-alive", location = "https://play.dhis2.org/40.0.1/api/optionSets.json?paging=false&filter=id:in:[VQ2lai3OfVG]&fields=id,name"), class = c("insensitive", 
        "list"))), list(status = 200L, version = "HTTP/2", headers = structure(list(
        server = "nginx", date = "Tue, 05 Sep 2023 13:15:46 GMT", 
    ...
    date = structure(1693919746, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.043838, namelookup = 8.7e-05, 
    connect = 0, pretransfer = 0.000267, starttransfer = 0.104987, 
    total = 0.10512)), class = "response")
