structure(list(url = "https://play.dhis2.org/40.0.1/api/dimensions.json?paging=false&filter=id:eq:gtuVl6NbXQV&fields=id,items[name]", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        ...
        `cache-control` = "no-cache, private", etag = "W/\"07f41bf5948f9be51a35e00c83ec12a15\"", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Tue, 05 Sep 2023 10:29:35 GMT", 
            ...
            connection = "keep-alive", location = "https://play.dhis2.org/40.0.1/api/dimensions.json?paging=false&filter=id:eq:gtuVl6NbXQV&fields=id,items[name]"), class = c("insensitive", 
    ...
    -1L), class = "data.frame"), content = charToRaw("{\"dimensions\":[{\"items\":[{\"name\":\"Consumption\"},{\"name\":\"End Balance\"},{\"name\":\"Quantity to be ordered\"}],\"id\":\"gtuVl6NbXQV\"}]}"), 
    date = structure(1693909775, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.039468, namelookup = 5.6e-05, 
    connect = 0, pretransfer = 0.000186, starttransfer = 0.090674, 
    total = 0.090839)), class = "response")
