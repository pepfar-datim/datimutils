structure(list(url = "https://play.dhis2.org/40.0.1/api/dataElements.json?paging=false&filter=id:in:[FTRrcoaog83]&fields=name,id", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Tue, 05 Sep 2023 10:29:28 GMT", `content-type` = "application/json;charset=UTF-8", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Tue, 05 Sep 2023 10:29:28 GMT", 
            `content-type` = "text/html", `content-length` = "162", 
            connection = "keep-alive", location = "https://play.dhis2.org/40.0.1/api/dataElements.json?paging=false&filter=id:in:[FTRrcoaog83]&fields=name,id"), class = c("insensitive", 
        "list"))), list(status = 200L, version = "HTTP/2", headers = structure(list(
        server = "nginx", date = "Tue, 05 Sep 2023 10:29:28 GMT", 
    ...
    date = structure(1693909768, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.046241, namelookup = 9.2e-05, 
    connect = 0, pretransfer = 0.000256, starttransfer = 0.104499, 
    total = 0.104632)), class = "response")
