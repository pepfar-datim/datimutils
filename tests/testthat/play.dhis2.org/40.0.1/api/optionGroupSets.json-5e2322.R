structure(list(url = "https://play.dhis2.org/40.0.1/api/optionGroupSets.json?paging=false&filter=id:in:[C31vHZqu0qU]&fields=id,name", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Tue, 05 Sep 2023 13:12:38 GMT", `content-type` = "application/json;charset=UTF-8", 
        ...
        `cache-control` = "no-cache, private", etag = "W/\"026820e415935eb760d46b89ebe2d493c\"", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Tue, 05 Sep 2023 13:12:38 GMT", 
            `content-type` = "text/html", `content-length` = "162", 
            connection = "keep-alive", location = "https://play.dhis2.org/40.0.1/api/optionGroupSets.json?paging=false&filter=id:in:[C31vHZqu0qU]&fields=id,name"), class = c("insensitive", 
        "list"))), list(status = 200L, version = "HTTP/2", headers = structure(list(
        server = "nginx", date = "Tue, 05 Sep 2023 13:12:38 GMT", 
    ...
    date = structure(1693919558, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.047895, namelookup = 8.3e-05, 
    connect = 0, pretransfer = 0.000238, starttransfer = 0.105051, 
    total = 0.105194)), class = "response")
