structure(list(url = "https://play.dhis2.org/40.0.1/api/organisationUnitGroups.json?paging=false&filter=name:in:[Country,Facility]&fields=name,organisationUnits[id]", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Tue, 05 Sep 2023 10:39:59 GMT", `content-type` = "application/json;charset=UTF-8", 
        ...
        `cache-control` = "no-cache, private", etag = "W/\"044a49e2123cf15a90833a134179d7f6b\"", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Tue, 05 Sep 2023 10:39:59 GMT", 
            `content-type` = "text/html", `content-length` = "162", 
            connection = "keep-alive", location = "https://play.dhis2.org/40.0.1/api/organisationUnitGroups.json?paging=false&filter=name:in:[Country,Facility]&fields=name,organisationUnits[id]"), class = c("insensitive", 
        "list"))), list(status = 200L, version = "HTTP/2", headers = structure(list(
        server = "nginx", date = "Tue, 05 Sep 2023 10:39:59 GMT", 
    ...
    -1L), class = "data.frame"), content = charToRaw("{\"organisationUnitGroups\":[{\"name\":\"Country\",\"organisationUnits\":[{\"id\":\"ImspTQPwCqd\"}]}]}"), 
    date = structure(1693910399, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.047657, namelookup = 7.2e-05, 
    connect = 0, pretransfer = 0.000225, starttransfer = 0.101078, 
    total = 0.101203)), class = "response")
