structure(list(url = "https://play.dhis2.org/40.0.1/api/organisationUnitGroups.json?paging=false&filter=id:in:[w1Atoz18PCL,CXw2yu5fodb]&fields=id,name", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Tue, 05 Sep 2023 10:39:51 GMT", `content-type` = "application/json;charset=UTF-8", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Tue, 05 Sep 2023 10:39:51 GMT", 
        ...
        server = "nginx", date = "Tue, 05 Sep 2023 10:39:51 GMT", 
    ...
    date = structure(1693910391, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.048207, namelookup = 8.2e-05, 
    connect = 0, pretransfer = 0.000254, starttransfer = 0.127602, 
    total = 0.127745)), class = "response")
