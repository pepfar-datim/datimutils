structure(list(url = "https://play.dhis2.org/40.0.1/api/organisationUnitGroups.json?paging=false&filter=name:in:[District,CHC]&fields=name,id", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Tue, 05 Sep 2023 13:25:45 GMT", `content-type` = "application/json;charset=UTF-8", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Tue, 05 Sep 2023 13:25:45 GMT", 
            `content-type` = "text/html", `content-length` = "162", 
            connection = "keep-alive", location = "https://play.dhis2.org/40.0.1/api/organisationUnitGroups.json?paging=false&filter=name:in:[District,CHC]&fields=name,id"), class = c("insensitive", 
        "list"))), list(status = 200L, version = "HTTP/2", headers = structure(list(
        server = "nginx", date = "Tue, 05 Sep 2023 13:25:45 GMT", 
    ...
    date = structure(1693920345, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.100077, namelookup = 0.000353, 
    connect = 0.10446, pretransfer = 0.150888, starttransfer = 0.257137, 
    total = 0.257245)), class = "response")
