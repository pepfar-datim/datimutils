structure(list(url = "https://play.dhis2.org/40.0.1/api/organisationUnitGroups.json?paging=false&filter=name:in:[District,CHC]&fields=name,id", 
    status_code = 200L, headers = structure(list(server = "nginx", 
        date = "Tue, 05 Sep 2023 10:39:53 GMT", `content-type` = "application/json;charset=UTF-8", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Tue, 05 Sep 2023 10:39:53 GMT", 
        ...
        server = "nginx", date = "Tue, 05 Sep 2023 10:39:53 GMT", 
    ...
    date = structure(1693910393, class = c("POSIXct", "POSIXt"
    ), tzone = "GMT"), times = c(redirect = 0.047935, namelookup = 8.4e-05, 
    connect = 0, pretransfer = 0.000247, starttransfer = 0.100634, 
    total = 0.10078)), class = "response")
