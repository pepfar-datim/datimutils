structure(list(url = "https://cop-test.datim.org/api/me", 
    status_code = 400L, headers = structure(list(server = "nginx", 
    ...
    "list")), all_headers = list(list(status = 301L, version = "HTTP/1.1", 
        headers = structure(list(server = "nginx", date = "Thu, 20 Jan 2022 17:44:29 GMT", 
            ...
            connection = "keep-alive", location = "https://cop-test.datim.org/api/me"), class = c("insensitive", 
        ...
        location = "https://cop-test.datim.org/api/me", `strict-transport-security` = "max-age=15768000"), class = c("insensitive", 
