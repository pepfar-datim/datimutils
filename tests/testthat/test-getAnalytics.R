...
data2 <- getAnalytics("displayProperty=NAME", "hierarchyMeta=true", dx = c("fbfJHSPpUQD","cYeuwXTCPkU"),
                     pe = c("THIS_YEAR","LAST_YEAR"), ou = c("ImspTQPwCqd","LEVEL-4"), base_url = "https://play.dhis2.org/2.33.5/", verbose = T)
